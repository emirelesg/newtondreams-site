...
function draw() {
  ...
  for (var x = xMin; x <= xMax; x += STEP) {
    var y =
      controls.a0.value +
      controls.a1.value * x +
      controls.a2.value * Math.pow(x, 2) +
      controls.a3.value * Math.pow(x, 3) +
      controls.a4.value * Math.pow(x, 4);
    plot.addPoint(x, y);
  }
}
