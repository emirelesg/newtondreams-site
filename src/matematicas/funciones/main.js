...
function draw() {
  ...
  if (started) {
    ...
    if (fx === 1) {
      ...
      x =
        controls.ax.value *
        Math.cos(controls.bx.value * t) *
        Math.exp(controls.cx.value * t);
    } else if (fx === 3) {
      x = controls.ax.value * Math.sin(controls.bx.value * t);
    } else if (fx === 4) {
      x =
        controls.ax.value *
        Math.sin(controls.bx.value * t) *
        Math.exp(controls.cx.value * t);
    } else if (fx === 5) {
      x =
        controls.ax.value +
        controls.bx.value * t +
        controls.cx.value * t * t +
        controls.dx.value * t * t * t;
    }
    ...
    if (fy === 1) {
      ...
      y =
        controls.ay.value *
        Math.cos(controls.by.value * t) *
        Math.exp(controls.cy.value * t);
    } else if (fy === 3) {
      y = controls.ay.value * Math.sin(controls.by.value * t);
    } else if (fy === 4) {
      y =
        controls.ay.value *
        Math.sin(controls.by.value * t) *
        Math.exp(controls.cy.value * t);
    } else if (fy === 5) {
      y =
        controls.ay.value +
        controls.by.value * t +
        controls.cy.value * t * t +
        controls.dy.value * t * t * t;
    }
