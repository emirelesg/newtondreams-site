<?php
    ...
    $active_sim     = $active['sim']['translacion_simetria'];
?>
<!doctype html>
<html lang="es">
                ...
                <div class="row">
                    <div class="col-lg-5 controls">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>A</td>
                                        <td class="w-100"><div id="a_slider"></div></td>
                                        <td><input id="a_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>B</td>
                                        <td class="w-100"><div id="b_slider"></div></td>
                                        <td><input id="b_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>C</td>
                                        <td class="w-100"><div id="c_slider"></div></td>
                                        <td><input id="c_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>D</td>
                                        <td class="w-100"><div id="d_slider"></div></td>
                                        <td><input id="d_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
                        <div class="row button-row">
                            <div class="col-12">
                                <button type="button" id="reset" class="btn btn-sm btn-outline-secondary btn-block">
