                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                        ...
                                        <td colspan=2>
                                            <div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="radio" name="tail" value="left" autocomplete="off" checked>Izquierda
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary">
                                                    <input type="radio" name="tail" value="right" autocomplete="off">Derecha
                                                </label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>z</td>
                                        <td class="w-100"><div id="z_slider"></div></td>
                                        <td><input id="z_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
