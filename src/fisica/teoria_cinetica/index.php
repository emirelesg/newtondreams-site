<?php
    ...
    $active_sim     = $active['sim']['teoria_cinetica'];
?>
<!doctype html>
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>Tamaño</td>
                                        <td class="w-100"><div id="size_slider"></div></td>
                                        <td><input id="size_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Cantidad (n)</td>
                                        <td class="w-100"><div id="amount_slider"></div></td>
                                        <td><input id="amount_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Temperatura (T)</td>
                                        <td class="w-100"><div id="temperature_slider"></div></td>
                                        <td><input id="temperature_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Volúmen (V)</td>
                                        <td class="w-100"><div id="volume_slider"></div></td>
                                        <td><input id="volume_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
