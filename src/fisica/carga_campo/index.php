<?php
    ...
    $active_sim     = $active['sim']['carga_campo'];
?>
<!doctype html>
<html lang="es">
                            ...
                            <div class="col">
                                <table class="table slider-table">
                                        ...
                                        <td colspan=2>
                                            <div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-sm w-100 btn-outline-primary">
                                                    <input type="radio" name="operation" value="left" autocomplete="off" checked> &larr;
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="radio" name="operation" value="mixed" autocomplete="off"> &#8646;
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary">
                                                    <input type="radio" name="operation" value="right" autocomplete="off"> &rarr;
                                                </label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="w-100"><div id="q_slider"></div></td>
                                        <td><input id="q_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
