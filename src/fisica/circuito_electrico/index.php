<?php
    ...
    $active_sim     = $active['sim']['circuito_electrico'];
?>
<!doctype html>
<html lang="es">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    ...
                                    <tr>
                                        <td nowrap>R<sub>1</sub></td>
                                        <td class="w-100"><div id="r1_slider"></div></td>
                                        <td><input id="r1_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>R<sub>2</sub></td>
                                        <td class="w-100"><div id="r2_slider"></div></td>
                                        <td><input id="r2_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>R<sub>3</sub></td>
                                        <td class="w-100"><div id="r3_slider"></div></td>
                                        <td><input id="r3_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
