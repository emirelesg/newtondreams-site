                        ...
                        <div class="row">
                            <div class="col clearfix">
                                ...
                                <div class="form-check form-check-inline float-right m-0 h-100">
                                    <input class="form-check-input" type="checkbox" id="showDamping" value="showDamping">
                                    <label class="form-check-label" for="showDamping">Mostrar Amortiguamiento</label>
                                </div>
                            </div>
                        </div> <!-- end .row- -->
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    ...
                                    <tr>
                                        <td nowrap>Amplitud</td>
                                        <td class="w-100"><div id="amplitude_slider"></div></td>
                                        <td><input id="amplitude_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>Constante Elástica (k)</td>
                                        <td class="w-100"><div id="k_slider"></div></td>
                                        <td><input id="k_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td>Constante de Amortiguamiento</td>
                                        <td class="w-100"><div id="damping_slider"></div></td>
                                        <td><input id="damping_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
