<?php
    ...
    $active_sim     = $active['sim']['barra_cargada'];
?>
<!doctype html>
<html lang="es">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    ...
                                    <tr>
                                        <td nowrap>Secciones</td>
                                        <td class="w-100"><div id="sections_slider"></div></td>
                                        <td><input id="sections_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
