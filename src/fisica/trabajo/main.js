...
function setup() {
  ...
  plots.work = graph.addPlot({
    shade: true,
    color: p$.COLORS.RED,
    shadeColor: p$.utils.rgbToRgba(p$.COLORS.RED, 0.15)
  });
...
function setupControls() {
  ...
  controls.distance = new p$.Slider({
    id: 'distance',
    start: 5,
    min: 1,
    max: 7.5,
...
function drawScene() {
  ...
  var labelWidth =
    w.ctx.measureText(controls.distance.label.val()).width * w.scaleX.toUnits;
