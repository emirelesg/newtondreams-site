                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>Flujo</td>
                                        <td class="w-100"><div id="flow_slider"></div></td>
                                        <td><input id="flow_label" type="text" class="input-100 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Densidad</td>
                                        <td class="w-100"><div id="density_slider"></div></td>
                                        <td><input id="density_label" type="text" class="input-100 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>D<sub>1</sub></td>
                                        <td class="w-100"><div id="d1_slider"></div></td>
                                        <td><input id="d1_label" type="text" class="input-100 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>D<sub>2</sub></td>
                                        <td class="w-100"><div id="d2_slider"></div></td>
                                        <td><input id="d2_label" type="text" class="input-100 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
