                        ...
                        <div class="row">
                            <div class="col clearfix">
                                ...
                                <div class="form-check form-check-inline float-right m-0 h-100">
                                    <input class="form-check-input" type="checkbox" id="showField" value="showField">
                                    <label class="form-check-label" for="showField">Mostrar Campo</label>
                                </div>
                            </div>
                        </div> <!-- end .row- -->
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>Carga (Q)</td>
                                        <td class="w-100"><div id="charge_slider"></div></td>
                                        <td><input id="charge_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Radio (r)</td>
