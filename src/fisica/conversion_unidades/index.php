<?php
    ...
    $active_sim     = $active['sim']['conversion_unidades'];
?>
<!doctype html>
<html lang="es">
                ...
                <div class="row">
                    <div class="col-lg-5 controls">
                            ...
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>Tipo</td>
                                        <td class="w-100">
                                            <select class="form-control form-control-sm" id="type" name="type" required></select>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <input type="text" id="value_a" placeholder="" class="text-center form-control-sm form-control" placeholder="0">
                                <select class="mt-3 form-control form-control-sm" id="unit_a" name="unit_a"></select>
                            </div>
                            <div class="col-1 text-center">=</div>
                            <div class="col">
                                <input type="text" id="value_b" placeholder="" class="text-center form-control-sm form-control" placeholder="0">
                                <select class="mt-3 form-control form-control-sm" id="unit_b" name="unit_b"></select>
                            </div>
                        </div> <!-- end .row- -->
                    </div>
