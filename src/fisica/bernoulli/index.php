<?php
    ...
    $active_sim     = $active['sim']['bernoulli'];
?>
<!doctype html>
<html lang="es">
            ...
            <section>
                <div class="row">
                    <div class="col-lg-5 controls">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <p class="mb-0">Utiliza las teclas 1 y 2 para conrolar la V<sub>superior</sub> y las teclas 3 y 4 para la V<sub>inferior</sub>.</p>
                            </div>
                        </div> <!-- end .row- -->
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>V<sub>superior</sub></td>
                                        <td class="w-100"><div id="vs_slider"></div></td>
                                        <td><input id="vs_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>V<sub>inferior</sub></td>
                                        <td class="w-100"><div id="vi_slider"></div></td>
                                        <td><input id="vi_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
