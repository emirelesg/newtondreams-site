...
function setup() {
  ...
  labels.accel = results.addLabel(160, 14, {
    name: 'Acceleración',
    units: 'm/s²',
    labelWidth: 100,
    decPlaces: 1
  ...
  labels.tension = results.addLabel(160, 14, {
    name: 'Tensión',
    units: 'N',
    labelWidth: 100,
    decPlaces: 1
...
function drawScene() {
  function drawInclinedPlane() {
    ...
    scene.triangle(0, 0, plane_width, 0, plane_width, plane_height);
  }
  ...
  function drawHangingMass() {
    ...
    if (controls.show_vectors.value) {
      ...
      var pos = scene.vectorFromMag(
        pulley_x + box2.half_side,
        box2.y + box2.half_side,
        weight,
        90,
        p$.COLORS.YELLOW
      );
  ...
  var box1_wire_y =
    box1.half_side > PULLEY_RADIUS ? PULLEY_RADIUS : box1.half_side;
  var box2_wire_x =
    box2.half_side > PULLEY_RADIUS
