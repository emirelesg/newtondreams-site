<?php
    ...
    $active_sim     = $active['sim']['momento_inercia'];
?>
<!doctype html>
<html lang="es">
                        ...
                        <div class="row">
                            <div class="col">
                                <table class="table slider-table">
                                    <tr>
                                        <td nowrap>Gráfica</td>
                                        <td colspan=2>
                                            <div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="radio" name="graph_type" value="pos" autocomplete="off" checked> Posición
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary">
                                                    <input type="radio" name="graph_type" value="vel" autocomplete="off"> Velocidad
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary">
                                                    <input type="radio" name="graph_type" value="accel" autocomplete="off"> Aceleración
                                                </label>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Objeto(s)</td>
                                        <td colspan=2>
                                            <div class="btn-group btn-block btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="checkbox" name="type" value="cylinder" autocomplete="off" checked> Cilíndro
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="checkbox" name="type" value="sphere" autocomplete="off" checked> Esfera
                                                </label>
                                                <label class="btn btn-sm w-100 btn-outline-primary active">
                                                    <input type="checkbox" name="type" value="wheel" autocomplete="off" checked> Rueda
                                                </label>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <table class="table slider-table">
                                    <tr>
                                        ...
                                        <td class="w-100" style="width: 100%"><div id="angle_slider"></div></td>
                                        <td><input id="angle_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                    <tr>
                                        <td nowrap>Radio</td>
                                        <td class="w-100"><div id="radius_slider"></div></td>
                                        <td><input id="radius_label" type="text" class="input-80 form-control form-control-sm text-center" readonly></td>
                                    </tr>
                                </table>
                            </div>
                        </div> <!-- end .row- -->
